                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" name="author" class="form-control" id="author"
                                    value="{{ old('author', $blog->author) }}" required autofocus>
                            </div>
                            <!-- /author -->
                             <!-- description-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keywords" class="form-control pt-4" id="keywords" data-role="tagsinput" value="{{ old('keywords',$blog->keywords) }}"
                                    required autofocus>
                            </div>
                            <!-- /seo keywords -->
                        </div>
