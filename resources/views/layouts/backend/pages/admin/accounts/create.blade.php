...
<script>
    $( document ).ready(function() {
        ...
        $("#submit-botton").click(async function(){
            ...
            var el = `<form method="POST" action="{{ route('admin.accounts.store') }}" style="display: none;" hidden>
            @csrf
                    ...
                    <div class="card text-white bg-dark mb-3">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col">
                                    <!-- submit -->
                                    <button type="button" class="btn btn-block btn-success submit-botton" id="submit-botton">Create</button>
                                    <!-- /submit -->
                                </div>
                                <div class="col">
                                    <!-- submit -->
