...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link type="image/x-icon"
    href="{{asset("assets/frontend/images/fav-icon.png")}}" rel="icon">

  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/bootstrap.min.css")}}" defer>
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/font-awesome.min.css")}}" defer>
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/owl.carousel.css")}}">
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/animations.css")}}">
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/style.css")}}">
  <link rel="stylesheet" type="text/css" href="{{asset("assets/frontend/styles/color.css")}}">
